        ...
        <div class="card shadow-lg border-0 rounded-4 p-4" style="background: #FFFDF8;">
            ...
            <div class="row g-3 mb-4">
                ...
                @if ($complain->complaint_type)
                    <div class="col-md-4"><strong>Type:</strong> {{ strtoupper($complain->complaint_type) }}</div>
                @endif
                <div class="col-md-4">
            ...
            @if ($complain->gst_firm_name || $complain->vat_firm_name || $complain->excise_name)
                ...
                <div class="row g-3 mb-4">
                    ...
                    @if ($complain->gst_description)
                        <div class="col-md-12"><strong>Description of Information:</strong>
                            {{ $complain->gst_description }}</div>
                    @endif
                    ...
                    @if ($complain->excise_vehicle_number)
                        <div class="col-md-4"><strong>Vehicle Number:</strong> {{ $complain->excise_vehicle_number }}</div>
                    @endif
