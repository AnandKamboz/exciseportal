                ...
                <form id="complaintForm" onsubmit="submitFinalStep(event)" enctype="multipart/form-data">
                    ...
                    <div class="step" id="step2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-half mb-3">
                                ...
                                <input type="text" name="complainant_phone" id="complainant_phone" class="form-control"
                                    value="{{ $userMobile }}" placeholder="Enter your Phone" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-half mb-3">
                                ...
                                <input type="text" name="pin_code" id="pin_code" class="form-control"
                                    placeholder="Enter 6-digit Pin Code" required oninput="handlePinInput(this)">
                        ...
                        <div class="row d-none" id="locationFields">
                            <div class="col-half mb-3">
                                ...
                                <input type="text" id="complainant_district" name="complainant_district"
                            ...
                            <div class="col-half mb-3">
                                ...
                                <input type="text" id="complainant_state" name="complainant_state" class="form-control"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="">
                                ...
                                <textarea name="complainant_address" id="complainant_address" class="form-control mb-3"
                        ...
                        <div class="row">
                            ...
                            <div class="col-half mb-3">
                                ...
                                <input type="text" id="confirm_bank_account" name="confirm_bank_account"
                                    class="form-control" placeholder="Re-enter Bank Account No."
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,16);">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="bank_branch_address" name="bank_branch_address" class="form-control"
                                    rows="3" placeholder="Enter Bank Branch Address"
                        ...
                        <div class="mt-2">
                            ...
                            <input type="file" name="document_upload" id="document_upload" class="form-control mb-2"
                                accept=".jpg,.jpeg,.png,.pdf" onchange="checkFileSize(this)">
                        </div>
                    ...
                    <div class="step" id="step4">
                            ...
                            <div class="col-half">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="firm_name" id="firm_name" class="form-control"
                                        placeholder="Enter Firm Name" oninput="sanitizeFirmName(this)">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-half mb-3">
                                ...
                                <textarea name="address_detail" id="address_detail" class="form-control" rows="3"
                                    placeholder="Enter Address" oninput="sanitizeAddress(this)"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" id="remarks" class="form-control mb-2" placeholder="Remarks"
