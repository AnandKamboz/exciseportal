   ...
   <body>
      ...
      <section class="background-radial-gradient overflow-hidden login-page">
         <style>
            ...
            /* Text under social section */
            .text-center p {
            color: #fff;
            font-weight: 500;
            margin-bottom: 10px;
            }
            /* Placeholder color (Bootstrap override + cross-browser) */
            ::placeholder {
                  ...
                  <div class="card bg-glass">
                     <div class="card-body px-4 py-5 px-md-5">
                        ...
                        <div class="text-center mb-4">
                           <img src="./assets/images/haryana-logo.png" alt="Logo" width="80" height="80" class="rounded-circle">
                        </div>
                        <h4 class="text-center mb-4 fw-bold">Excise and Taxation Department
                        </h4>
                        {{--
                        <form>
                           <!-- Mobile Number -->
                           <div class="form-outline mb-4 d-flex align-items-center">
                              <input type="tel" id="mobileNumber" class="form-control me-2" placeholder="Enter Mobile Number" />
                           ...
                           <!-- Submit Button -->
                           <div>
                              <a href="#" class="btn btn-primary btn-block w-100 mb-4">
                              Submit
                              </a>
                           </div>
                        </form>
                        ...
                        <form id="loginForm">
                           ...
                           <div id="mobileSection" class="mb-3">
                              <input type="text" name="mobile" id="mobile" class="form-control"
                                 placeholder="Enter 10 digit mobile" />
                              <button type="button" id="sendOtpBtn" class="btn btn-primary btn-block w-100 mt-3">
                              Send OTP
                              </button>
                           </div>
                           <!-- Success Message -->
                           ...
                           <div id="otpSection" class="hidden mt-3">
                              <input type="text" name="otp" id="otp" class="form-control otp-input" maxlength="6"
                                 placeholder="Enter 6 digit OTP" />
                              <button type="button" id="loginBtn" class="btn btn-primary btn-block w-100 mt-3">
                              Login
                              </button>
                           </div>
                        </form>
